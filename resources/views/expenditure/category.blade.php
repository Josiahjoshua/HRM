          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  @foreach ($expenditure  as $products)
                  <tr>
                    ...
                    <td>
                      <div class="d-flex">
                          @if ($products->category_name == "Fund Request" || $products->category_name == "Perdeim" || $products->category_name == "Net Salary")
                            
                          @else
                            
                          
                        <a href="{{route('expenditureCategory.edit', $products->id)}}" class="btn-sm btn-primary mr-3">Edit</a>
                      
                        <form action="{{ route('expenditureCategory.destroy', $products->id) }}" method="post">
                          @csrf
                          @method('DELETE')
                        ...
                        @endif
                       <a href="{{route('expenditureCategory.show', $products->id)}}" class="btn-sm btn-info">View Monthly Expenditure</a>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" method="post" action="{{route('expenditureCategory.store')}}" id="loanvalueform" enctype="multipart/form-data">
            <div class="modal-body">
