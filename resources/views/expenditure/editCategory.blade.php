...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-body">
<form role="form" method="post" action="{{ route('expenditureCategory.update', $expenditure->id) }}" id="loanvalueform"
    ...
    <div class="form-group">
        ...
        <input type="text" name="category_name" class="form-control" id="recipient-name1" required value="{{ $expenditure->category_name }}">
    </div>
