                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-striped blue-bordered-table">
                                <thead>
                                    <tr >
                                        <th class="text-primary">Available  Cash</th>
                                        <td>{{ number_format($cashAvailable, 2) }}</td>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">List of Cash details</h3>
                            </div>
                                            ...
                                            <tr class="text-nowrap">
                                                ...
                                                <td>
                                                    ...
                                                    Edit
                                                        ...
                                                        <a href="{{ route('cash.edit', $products->id) }}"
                                                            class="btn-sm btn-info mr-3">Edit</a>


                                                        <form action="{{ route('cash.destroy', $products->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('DELETE')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" method="post" action="{{ route('cash.store') }}" id="loanvalueform"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        @php
                            ...
                            $pettyCashEdit = \App\Models\Cash::find($id);
                        @endphp
