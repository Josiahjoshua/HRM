                    ...
                    <div class="col-md-9">
                        <div class="card card-primary">
                            ...
                            <div class="modal-body">
                                ...
                                <form role="form" method="post" action="{{ route('cash.update', $CashEdit->id) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="type" class="form-control custom-select" id="type"
                                            ...
                                            <option value="income" {{ $CashEdit->type == 'income' ? 'selected' : '' }}>
                                                Income</option>
                                            <option value="expenditure"
                                                {{ $CashEdit->type == 'expenditure' ? 'selected' : '' }}>Expenditure
                                            </option>
                                        </select>
                                    </div>

                                    <div class="form-group" id="income"
                                        style="{{ $CashEdit->type == 'income' ? 'display:block;' : 'display:none;' }}">
                                        <div class="form-group">
                                            <label>From</label>
                                            <select name="source_destination" class="form-control custom-select"
                                                ...
                                                <option value="cash"
                                                    {{ $CashEdit->source_destination == 'cash' ? 'selected' : '' }}>Cash in
                                                    hand</option>
                                                <option value="other"
                                                    {{ $CashEdit->source_destination == 'other' ? 'selected' : '' }}>Other
                                                </option>
                                                @foreach ($banks as $bank)
                                                    <option value="{{ $bank->bank_name }}"
                                                        {{ $CashEdit->source_destination == $bank->bank_name ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group" id="otherField"
                                            style="{{ $CashEdit->source_destination == 'other' ? 'display:block;' : 'display:none;' }}">
                                            <label>Other money source:</label>
                                            <input type="text" name="othersource_destination" class="form-control"
                                                value="{{ $CashEdit->othersource_destination ?? '' }}"
                                                placeholder="Enter money source">
                                        </div>
                                    </div>

                                    <div class="form-group" id="expenditure"
                                        style="{{ $CashEdit->type == 'expenditure' ? 'display:block;' : 'display:none;' }}">
                                        <div class="form-group">
                                            <label>To</label>
                                            <select name="source_destination" class="form-control custom-select"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="date" class="form-control"
                                            value="{{ $CashEdit->date }}" id="recipient-name1" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="message-text" class="control-label">Amount</label>
                                        <input type="number" step="any" name="amount" class="form-control"
                                            value="{{ $CashEdit->amount }}" id="recipient-name1" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="description" class="control-label">Description</label>
                                        <textarea name="description" class="form-control" id="description" rows="3" required>{{ $CashEdit->description }}</textarea>
                                    </div>
