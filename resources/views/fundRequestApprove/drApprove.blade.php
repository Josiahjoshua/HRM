                                        ...
                                        <tbody>
                                            @foreach ($fundrequest as $apply)
                                                <tr>
                                                    ...
                                                    <td>{{ $apply->reason }}</td>
                                                    <td>{{ number_format($apply->amount) }}</td>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form role="form" method="POST" action="{{ route('fundrequest.drDecline') }}"
                                ...
                                <input type="hidden" id="asset_id_input" name="fund_request_id" value="">
                                <div class="modal-body">
