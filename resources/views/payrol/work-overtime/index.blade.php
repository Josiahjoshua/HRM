                                    ...
                                    <tbody>
                                        @foreach ($work_overtime as $work)
                                            <tr>
                                                ...
                                                <td><a href="{{ route('work.download', $work->id) }}" target="_blank">View
                                                        Proof</a></td>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        @if (is_null($work->status))
                                                            @can('edit work-overtime')
                                                                <a href="{{ route('work-overtime.edit', $work->id) }}"
                                                                    title="edit"
                                                                    class="m-2 btn btn-sm btn-info waves-effect waves-light leaveapproval"
                                                                    data-id="<?php echo $work->id; ?>">Edit</a>
                                                            @endcan

                                                            @can('delete work-overtime')
                                                                <form action="{{ route('work-overtime.destroy', $work->id) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('DELETE')
                        ...
                        <form method="post" ction="{{ route('work-overtime.store') }}" id="leaveform"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="any" name="hours" class="form-control"
                                        id="recipient-name1" required>
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Amount Per Hour</label>
                                    <input type="number" step="any" name="amountPerHour" class="form-control"
                                        id="recipient-name1" required>
                                </div>
                                <div class="form-group">
