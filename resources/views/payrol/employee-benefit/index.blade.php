                ...
                <div class="col-12">
                    <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a data-toggle="modal"
                            data-target="#leavemodel" data-whatever="@getbootstrap" class="text-white"><i class=""
                                aria-hidden="true"></i> Assign Benefits</a></button>
                                    ...
                                    <tbody>
                                        @foreach ($benefit_employee as $benefit)
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    <a href="{{ route('employee-benefit.edit', $benefit->id) }}"
                                                        class="btn btn-primary">Edit</a>

                                                    <form action="{{ route('employee-benefit.destroy', $benefit->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
            ...
            <div class="modal fade" id="leavemodel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
                <div class="modal-dialog" role="document">
                    <div class="modal-content ">
                        ...
                        <form method="post" ction="{{ route('employee-benefit.store') }}" id="leaveform"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group ">
                                    ...
                                    <select class="form-select" aria-label="Default select example"
                                        data-placeholder="Choose a Category" tabindex="1" name="benefit_id" id="assignval"
