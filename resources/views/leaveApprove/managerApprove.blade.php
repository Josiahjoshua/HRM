                                                    ...
                                                    <td class="d-flex">
                                                        @if (is_null($apply->statusManager))
                                                            ...
                                                            <button class="view-leave-modal btn btn-warning mr-2"
                                                                ...
                                                                data-target="#RejectModal" onclick="setLeaveId(this)">
                                                                Reject
                                                            </button>
                                                            <br>
                                                        @elseif($apply->statusManager == 1)

                                                        @elseif($apply->statusmanger == 0)
                                                        @endif
                                                    </td>
                                                </tr>
                                            @endforeach
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form role="form" method="POST" action="{{ route('leave.managerDecline') }}"
