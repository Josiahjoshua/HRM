                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex">
                        ...
                        <a href="{{route('incomeCategory.edit', $products->id)}}" class="btn-sm btn-primary mr-3">Edit</a>
                      
                        <form action="{{ route('incomeCategory.destroy', $products->id) }}" method="post">
                          @csrf
                          @method('DELETE')
                          <button class="btn-sm btn-danger mr-3" type="submit" onclick="return confirm('Are you sure  you want to delete?')">Delete</button>
                          <?= csrf_field() ?>
                        </form>
                       <a href="{{route('incomeCategory.show', $products->id)}}" class="btn-sm btn-info">View Monthly Income</a>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" method="post" action="{{route('incomeCategory.store')}}" id="loanvalueform" enctype="multipart/form-data">
            <div class="modal-body">
